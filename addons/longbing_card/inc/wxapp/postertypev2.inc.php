...
if( $type ) 
{
	$list_img = pdo_getall("longbing_card_poster", array( "uniacid" => $uniacid, "status" => 1, "type_id" => $type ), array( "id", "title", "img", "top", "type_id", "cover" ), "", array( "top desc", "id desc" ));
}
else 
{
	if( $type == 0 ) 
	{
		$list_img = pdo_getall("longbing_card_poster", array( "uniacid" => $uniacid, "status" => 1 ), array( "id", "title", "img", "top", "type_id", "cover" ), "", array( "top desc", "id desc" ));
	}
}
