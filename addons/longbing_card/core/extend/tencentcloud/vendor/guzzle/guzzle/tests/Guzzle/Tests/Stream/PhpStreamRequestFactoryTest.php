<?php  namespace Guzzle\Tests\Stream;
class PhpStreamRequestFactoryTest extends \Guzzle\Tests\GuzzleTestCase 
{
	...
	protected function setUp() 
	{
		...
		$this->factory = new \Guzzle\Stream\PhpStreamRequestFactory();
	}
	...
	{
		$request = $this->client->get("/");
		$this->factory = $this->getMockBuilder("Guzzle\\Stream\\PhpStreamRequestFactory")->setMethods(array( "createContext", "createStream" ))->getMock();
		$this->factory->expects($this->never())->method("createContext");
		$this->factory->expects($this->once())->method("createStream")->will($this->returnValue(new \Guzzle\Stream\Stream(fopen("php://temp", "r"))));
	...
	public function testAppliesProxySettings() 
	{
		...
		$this->factory = $this->getMockBuilder("Guzzle\\Stream\\PhpStreamRequestFactory")->setMethods(array( "createStream" ))->getMock();
		$this->factory->expects($this->once())->method("createStream")->will($this->returnValue(new \Guzzle\Stream\Stream(fopen("php://temp", "r"))));
