...
class OperationTest extends \Guzzle\Tests\GuzzleTestCase 
{
	...
	{
		$c = new \Guzzle\Service\Description\Operation(array( "name" => "test", "summary" => "doc", "notes" => "notes", "documentationUrl" => "http://www.example.com", "httpMethod" => "POST", "uri" => "/api/v1", "responseClass" => "array", "responseNotes" => "returns the json_decoded response", "deprecated" => true, "parameters" => array( "key" => array( "required" => true, "type" => "string", "maxLength" => 10 ), "key_2" => array( "required" => true, "type" => "integer", "default" => 10 ) ) ));
		...
		$this->assertEquals(array( "key" => new \Guzzle\Service\Description\Parameter(array( "name" => "key", "required" => true, "type" => "string", "maxLength" => 10, "parent" => $c )), "key_2" => new \Guzzle\Service\Description\Parameter(array( "name" => "key_2", "required" => true, "type" => "integer", "default" => 10, "parent" => $c )) ), $c->getParams());
		$this->assertEquals(new \Guzzle\Service\Description\Parameter(array( "name" => "key_2", "required" => true, "type" => "integer", "default" => 10, "parent" => $c )), $c->getParam("key_2"));
	...
	{
		$c = new \Guzzle\Service\Description\Operation(array( "name" => "test", "class" => "Guzzle\\Service\\Command\\ClosureCommand", "parameters" => array( "p" => new \Guzzle\Service\Description\Parameter(array( "name" => "foo" )) ) ));
		$this->assertEquals("Guzzle\\Service\\Command\\ClosureCommand", $c->getClass());
	}
	public function testConvertsToArray() 
	{
		$data = array( "name" => "test", "class" => "Guzzle\\Service\\Command\\ClosureCommand", "summary" => "test", "documentationUrl" => "http://www.example.com", "httpMethod" => "PUT", "uri" => "/", "parameters" => array( "p" => array( "name" => "foo" ) ) );
		$c = new \Guzzle\Service\Description\Operation($data);
		$toArray = $c->toArray();
		unset($data["name"]);
	...
	{
		return new \Guzzle\Service\Description\Operation(array( "parameters" => array( "data" => new \Guzzle\Service\Description\Parameter(array( "type" => "string" )) ) ));
	}
	public function testCanBuildUpCommands() 
	{
		$c = new \Guzzle\Service\Description\Operation(array( ));
		$c->setName("foo")->setClass("Baz")->setDeprecated(false)->setSummary("summary")->setDocumentationUrl("http://www.foo.com")->setHttpMethod("PUT")->setResponseNotes("oh")->setResponseClass("string")->setUri("/foo/bar")->addParam(new \Guzzle\Service\Description\Parameter(array( "name" => "test" )));
	...
	{
		$c = new \Guzzle\Service\Description\Operation(array( ));
		$c->addParam(new \Guzzle\Service\Description\Parameter(array( "name" => "foo" )));
	...
	{
		$command = new \Guzzle\Service\Description\Operation(array( "parameters" => array( "foo" => new \Guzzle\Service\Description\Parameter(array( )) ) ));
	...
	{
		$o = new \Guzzle\Service\Description\Operation(array( "notes" => "foo" ));
	...
	{
		$o = new \Guzzle\Service\Description\Operation(array( "data" => array( "foo" => "baz", "bar" => 123 ) ));
	...
	{
		$s = new \Guzzle\Service\Description\ServiceDescription();
		$o = new \Guzzle\Service\Description\Operation(array( ), $s);
		$this->assertSame($s, $o->getServiceDescription());
	}
	public function testValidatesResponseType() 
	{
		$o = new \Guzzle\Service\Description\Operation(array( "responseClass" => "array", "responseType" => "foo" ));
	}
	public function testInfersResponseType() 
	{
		$o = $this->getOperation();
		$o->setServiceDescription(new \Guzzle\Service\Description\ServiceDescription(array( "models" => array( "Foo" => array( ) ) )));
		...
		$this->assertEquals("class", $o->setResponseClass("Guzzle\\Tests\\Service\\Description\\OperationTest")->getResponseType());
		$this->assertEquals("model", $o->setResponseClass("Foo")->getResponseType());
	}
	public function testHasResponseType() 
	{
		$o = new \Guzzle\Service\Description\Operation(array( "responseClass" => "array" ));
		$this->assertEquals("primitive", $o->getResponseType());
		$o = new \Guzzle\Service\Description\Operation();
		$this->assertEquals("primitive", $o->getResponseType());
		$this->assertEquals("model", $o->setResponseType("model")->getResponseType());
	}
	public function testHasAdditionalParameters() 
	{
		$o = new \Guzzle\Service\Description\Operation(array( "additionalParameters" => array( "type" => "string", "name" => "binks" ), "parameters" => array( "foo" => array( "type" => "integer" ) ) ));
	...
	{
		return new \Guzzle\Service\Description\Operation(array( "name" => "OperationTest", "class" => get_class($this), "parameters" => array( "test" => array( "type" => "object" ), "bool_1" => array( "default" => true, "type" => "boolean" ), "bool_2" => array( "default" => false ), "float" => array( "type" => "numeric" ), "int" => array( "type" => "integer" ), "date" => array( "type" => "string" ), "timestamp" => array( "type" => "string" ), "string" => array( "type" => "string" ), "username" => array( "type" => "string", "required" => true, "filters" => "strtolower" ), "test_function" => array( "type" => "string", "filters" => "Guzzle\\Tests\\Service\\Description\\OperationTest" . "::strtoupper" ) ), "errorResponses" => array( array( "code" => 503, "reason" => "InsufficientCapacity", "class" => "Guzzle\\Exception\\RuntimeException" ) ) ));
	}
}
?>