...
class AbstractMessageTest extends \Guzzle\Tests\GuzzleTestCase 
{
	...
	public function testAddHeaders() 
	{
		...
		$this->assertEquals($this->mock, $this->mock->addHeaders(array( "X-Data" => "123" )));
	...
	{
		$h = new \Guzzle\Http\Message\Header("A", "B");
	...
	public function testGetHeaderLinesUsesGlue() 
	{
		...
		$this->assertEquals(array( "a: b! e", "c: d" ), $this->mock->getHeaderLines());
	}
	...
	{
		$this->mock->addHeaders(array( "test" => "123", "Test" => "abc" ));
