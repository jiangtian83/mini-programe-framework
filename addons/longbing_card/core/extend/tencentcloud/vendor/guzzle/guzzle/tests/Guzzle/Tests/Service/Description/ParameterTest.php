...
{
	protected $data = array( "name" => "foo", "type" => "bar", "required" => true, "default" => "123", "description" => "456", "minLength" => 2, "maxLength" => 5, "location" => "body", "static" => "static!", "filters" => array( "trim", "json_encode" ) );
	public function testCreatesParamFromArray() 
	{
		$p = new \Guzzle\Service\Description\Parameter($this->data);
	...
	public function testUsesStatic() 
	{
		...
		$d["default"] = "booboo";
		$d["static"] = true;
		$p = new \Guzzle\Service\Description\Parameter($d);
	...
	{
		$p = new \Guzzle\Service\Description\Parameter(array( "type" => "boolean" ));
	...
	{
		$p = new \Guzzle\Service\Description\Parameter(array( "name" => "myname", "location" => "foo", "sentAs" => "Hello" ));
		$this->assertEquals("foo", $p->getLocation());
		$this->assertEquals("Hello", $p->getSentAs());
	}
	public function testParsesTypeValues() 
	{
		$p = new \Guzzle\Service\Description\Parameter(array( "type" => "foo" ));
		$this->assertEquals("foo", $p->getType());
	}
	public function testValidatesComplexFilters() 
	{
		$p = new \Guzzle\Service\Description\Parameter(array( "filters" => array( array( "args" => "foo" ) ) ));
	}
	public function testCanBuildUpParams() 
	{
		$p = new \Guzzle\Service\Description\Parameter(array( ));
	...
	public function testAllowsNestedShape() 
	{
		...
		$param = new \Guzzle\Service\Description\Parameter(array( "parent" => $command, "name" => "foo", "type" => "object", "location" => "query", "properties" => array( "foo" => array( "type" => "object", "required" => true, "properties" => array( "baz" => array( "name" => "baz", "type" => "bool" ) ) ), "bar" => array( "name" => "bar", "default" => "123" ) ) ));
	...
	{
		$that = $this;
		$param = new \Guzzle\Service\Description\Parameter(array( ));
	...
	{
		$param1 = new \Guzzle\Service\Description\Parameter(array( "name" => "parent" ));
		$param2 = new \Guzzle\Service\Description\Parameter(array( "name" => "child" ));
	...
	{
		$p = new \Guzzle\Service\Description\Parameter(array( "type" => "object", "additionalProperties" => array( "type" => "string" ) ));
		...
		$p = new \Guzzle\Service\Description\Parameter(array( "type" => "object" ));
		$this->assertTrue($p->getAdditionalProperties());
	}
	public function testAddsItems() 
	{
		$p = new \Guzzle\Service\Description\Parameter(array( "type" => "array", "items" => array( "type" => "string" ) ));
	...
	{
		$p = new \Guzzle\Service\Description\Parameter();
	...
	{
		$p = new \Guzzle\Service\Description\Parameter(array( "type" => "object", "additionalProperties" => array( "type" => "string" ) ));
		$this->assertEquals(array( "type" => "object", "additionalProperties" => array( "type" => "string" ) ), $p->toArray());
	}
	public function testResolvesRefKeysRecursively() 
	{
		$description = new \Guzzle\Service\Description\ServiceDescription(array( "models" => array( "JarJar" => array( "type" => "string", "default" => "Mesa address tha senate!" ), "Anakin" => array( "type" => "array", "items" => array( "\$ref" => "JarJar" ) ) ) ));
		$p = new \Guzzle\Service\Description\Parameter(array( "\$ref" => "Anakin", "description" => "added" ), $description);
		$this->assertEquals(array( "type" => "array", "items" => array( "type" => "string", "default" => "Mesa address tha senate!" ), "description" => "added" ), $p->toArray());
	}
	public function testResolvesExtendsRecursively() 
	{
		...
		$description = new \Guzzle\Service\Description\ServiceDescription(array( "models" => array( "JarJar" => $jarJar, "Anakin" => $anakin ) ));
		$p = new \Guzzle\Service\Description\Parameter(array( "extends" => "Anakin", "format" => "date" ), $description);
		$this->assertEquals(array( "type" => "array", "format" => "date", "items" => array( "type" => "string", "default" => "Mesa address tha senate!", "description" => "b" ) ), $p->toArray());
	}
	public function testHasKeyMethod() 
	{
		$p = new \Guzzle\Service\Description\Parameter(array( "name" => "foo", "sentAs" => "bar" ));
	...
	{
		$p = new \Guzzle\Service\Description\Parameter(array( "type" => "array", "name" => "Abc", "items" => array( "name" => "Foo", "type" => "object" ) ));
		$result = $p->toArray();
		$this->assertEquals(array( "type" => "array", "items" => array( "name" => "Foo", "type" => "object", "additionalProperties" => true ) ), $result);
	}
	public function dateTimeProvider() 
	{
		$d = "October 13, 2012 16:15:46 UTC";
		return array( array( $d, "date-time", "2012-10-13T16:15:46Z" ), array( $d, "date", "2012-10-13" ), array( $d, "timestamp", strtotime($d) ), array( new \DateTime($d), "timestamp", strtotime($d) ) );
	}
