...
class ExceptionCollectionTest extends \Guzzle\Tests\GuzzleTestCase 
{
	...
	{
		return array( new \Exception("Test"), new \Exception("Testing") );
	}
	public function testAggregatesExceptions() 
	{
		$e = new \Guzzle\Common\Exception\ExceptionCollection();
	...
	{
		$e1 = new \Guzzle\Common\Exception\ExceptionCollection();
		$e1->add(new \Exception("Test"));
		$e2 = new \Guzzle\Common\Exception\ExceptionCollection("Meta description!");
		$e2->add(new \Exception("Test 2"));
		$e3 = new \Guzzle\Common\Exception\ExceptionCollection();
