...
class ServiceDescriptionLoaderTest extends \Guzzle\Tests\GuzzleTestCase 
{
	...
	{
		$d = \Guzzle\Service\Description\ServiceDescription::factory(array( "foo" => true, "baz" => array( "bar" ), "apiVersion" => "123", "operations" => array( ) ));
	...
	{
		$d = \Guzzle\Service\Description\ServiceDescription::factory(array( "operations" => array( "abstract" => array( "httpMethod" => "HEAD", "parameters" => array( "test" => array( "type" => "string", "required" => true ) ) ), "abstract2" => array( "uri" => "/test", "extends" => "abstract" ), "concrete" => array( "extends" => "abstract2" ), "override" => array( "extends" => "abstract", "httpMethod" => "PUT" ), "override2" => array( "extends" => "override", "httpMethod" => "POST", "uri" => "/" ) ) ));
	...
	{
		\Guzzle\Service\Description\ServiceDescription::factory(array( "operations" => array( "concrete" => array( "extends" => "missing" ) ) ));
	}
	public function testAllowsMultipleInheritance() 
	{
		$description = \Guzzle\Service\Description\ServiceDescription::factory(array( "operations" => array( "a" => array( "httpMethod" => "GET", "parameters" => array( "a1" => array( "default" => "foo", "required" => true, "prepend" => "hi" ) ) ), "b" => array( "extends" => "a", "parameters" => array( "b2" => array( ) ) ), "c" => array( "parameters" => array( "a1" => array( "default" => "bar", "required" => true, "description" => "test" ), "c3" => array( ) ) ), "d" => array( "httpMethod" => "DELETE", "extends" => array( "b", "c" ), "parameters" => array( "test" => array( ) ) ) ) ));
	...
	{
		$description = \Guzzle\Service\Description\ServiceDescription::factory(array( "operations" => array( ), "description" => "Foo", "apiVersion" => "bar" ));
