<?php  namespace Symfony\Component\EventDispatcher\DependencyInjection;
class RegisterListenersPass implements \Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface 
{
	protected $dispatcherService = NULL;
	protected $listenerTag = NULL;
	protected $subscriberTag = NULL;
