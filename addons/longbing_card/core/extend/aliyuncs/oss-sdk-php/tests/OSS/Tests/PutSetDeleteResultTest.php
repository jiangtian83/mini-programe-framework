...
class ResultTest extends \PHPUnit_Framework_TestCase 
{
	...
	{
		$header = array( "x-oss-request-id" => "582AA51E004C4550BD27E0E4", "etag" => "595FA1EA77945233921DF12427F9C7CE", "content-md5" => "WV+h6neUUjOSHfEkJ/nHzg==", "info" => array( "http_code" => "200", "method" => "PUT" ) );
		$response = new \OSS\Http\ResponseCore($header, "this is a mock body, just for test", 200);
