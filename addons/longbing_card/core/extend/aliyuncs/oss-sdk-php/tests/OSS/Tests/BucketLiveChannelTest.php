...
class BucketLiveChannelTest extends \PHPUnit_Framework_TestCase 
{
	...
	{
		$config = new \OSS\Model\LiveChannelConfig(array( "description" => "live channel 1", "type" => "HLS", "fragDuration" => 10, "fragCount" => 5, "playListName" => "hello.m3u8" ));
	...
	{
		$config = new \OSS\Model\LiveChannelConfig(array( "description" => "live channel 1", "type" => "HLS" ));
		$info = $this->client->putBucketLiveChannel($this->bucketName, "live-1", $config);
		$this->client->deleteBucketLiveChannel($this->bucketName, "live-1");
		$this->assertEquals("live-1", $info->getName());
		$this->assertEquals("live channel 1", $info->getDescription());
	...
	public function testListLiveChannels() 
	{
		...
		$config = new \OSS\Model\LiveChannelConfig(array( "description" => "live channel 2", "type" => "HLS", "fragDuration" => 10, "fragCount" => 5, "playListName" => "hello.m3u8" ));
	...
	public function testDeleteLiveChannel() 
	{
		...
		$config = new \OSS\Model\LiveChannelConfig(array( "description" => "live channel to delete", "type" => "HLS", "fragDuration" => 10, "fragCount" => 5, "playListName" => "hello.m3u8" ));
	...
	public function testLiveChannelInfo() 
	{
		...
		$config = new \OSS\Model\LiveChannelConfig(array( "description" => "test live channel info", "type" => "HLS", "fragDuration" => 10, "fragCount" => 5, "playListName" => "hello.m3u8" ));
		$this->client->putBucketLiveChannel($this->bucketName, $channelName, $config);
