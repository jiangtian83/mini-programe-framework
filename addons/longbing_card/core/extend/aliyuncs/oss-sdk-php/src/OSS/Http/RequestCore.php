...
class RequestCore 
{
	...
	public $response_raw_headers = NULL;
	public $response_error_body = NULL;
	public $write_file_handle = NULL;
	...
	public function prep_request() 
	{
		...
		switch( $this->method ) 
		{
			case self::HTTP_PUT: curl_setopt($curl_handle, CURLOPT_CUSTOMREQUEST, "PUT");
			...
			break;
			case self::HTTP_POST: curl_setopt($curl_handle, CURLOPT_CUSTOMREQUEST, "POST");
			if( isset($this->read_stream) ) 
			{
				if( !isset($this->read_stream_size) || $this->read_stream_size < 0 ) 
				{
			...
			break;
			case self::HTTP_HEAD: curl_setopt($curl_handle, CURLOPT_CUSTOMREQUEST, self::HTTP_HEAD);
